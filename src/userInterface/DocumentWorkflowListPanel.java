...
public class DocumentWorkflowListPanel extends JPanel {
    ...
    public void setData(ArrayList<Document> documents) {
        ...
        Document document;
        this.data = new String[nbDocuments][NB_TITLES];

        while (iDocument < nbDocuments) {
            document = documents.get(iDocument);

            this.data[iDocument][0] = Integer.toString(document.getNumber());
            ...
            if (document.getCreditLimit() != null) {
                this.data[iDocument][3] = "" + document.getCreditLimit().toString();
            }

            this.data[iDocument][4] = "" + document.getType().toString();
            this.data[iDocument][5] = "" + document.getworkflowNumber().toString();
